...
PATCHES=(
	...
	"${FILESDIR}/Change-torch_path-part-for-cpp-extensions.patch"
	"${FILESDIR}/Don-t-build-libtorch-again-for-PyTorch.patch"
	"${FILESDIR}/Fix-ROCm-paths-in-LoadHIP.cmake.patch"
	...
	"${FILESDIR}/Use-FHS-compliant-paths-from-GNUInstallDirs-module.patch"
